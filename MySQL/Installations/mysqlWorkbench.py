...
# It is not necessary to use a GUI. We may interact with our MySQL databases through the terminal, but the GUI makes it much easier to see our data and create new databases.
